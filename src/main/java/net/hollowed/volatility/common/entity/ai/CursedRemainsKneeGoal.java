...
import net.hollowed.volatility.common.entity.extra.CursedRemainsKneeExtra;
...
public class CursedRemainsKneeGoal extends Goal {
    ...
    private final int attackInterval = 25;
    private long lastCanUseCheck;
    private static final long COOLDOWN_BETWEEN_CAN_USE_CHECKS = 25L;
    private int failedPathFindingPenalty = 0;
    private boolean canPenalize = false;

    public CursedRemainsKneeGoal(PathfinderMob p_25552_, double p_25553_, boolean p_25554_) {
        this.mob = p_25552_;
    ...
    protected void checkAndPerformAttack(LivingEntity target, double distanceToTarget) {
        ...
        if (distanceToTarget <= attackRange && this.ticksUntilNextAttack <= 0) {
            ...
            if(!this.mob.isDeadOrDying()) {
                CursedRemainsKneeExtra.execute(this.mob);
            }
