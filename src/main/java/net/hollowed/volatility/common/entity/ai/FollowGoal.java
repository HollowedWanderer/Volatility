...
public class FollowGoal extends Goal {
    ...
    public FollowGoal(PathfinderMob p_25552_, double p_25553_, boolean p_25554_) {
        this.mob = p_25552_;
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.getAttackReachSqr(livingentity) >= this.mob.distanceToSqr(livingentity.getX(), livingentity.getY(), livingentity.getZ())) {
                this.mob.getNavigation().stop();
            }
    ...
    protected int getAttackInterval() {
        return this.adjustedTickDelay(-1);
    }
