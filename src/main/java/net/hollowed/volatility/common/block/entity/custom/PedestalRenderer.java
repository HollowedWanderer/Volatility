...
public class PedestalRenderer implements BlockEntityRenderer<PedestalTile> {
    ...
    @Override
    public void render(PedestalTile pedestalTile, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
